...
public class Tablero implements DatosGeneralesJuego{
	...
	public void dibujar(Graphics2D g) {
		for (int Y = 0; Y < filas; Y++) {
			for (int X = 0; X < columnas; X++) {
				...
				//dibujar casilla
				if(Tablero[X][Y] == no_tetro) { //Solo es est�tico estilo ajedrez en 2D
	...
	public void dibujarPuntuacion(Graphics2D g) {
		...
		g.drawString("Esta es tu puntuaci�n: " + puntuacion, posicionPuntuacion.intX()+5, posicionPuntuacion.intY()+11);
